...
abstract class BaseFacade {
    ...
    protected function process($request, $operation, $jsonHelper) {
        ...
        if($isValidResponse === FALSE){
            //echo '<div class="col-lg-10 col-lg-offset-1"><div class="alert alert-danger" role="alert"><strong>Oh snap!</strong> Something Wrong in the response : Please check the internet connection ' . $jsonResponse . ' </div></div>';
            throw new Exception('Payment gateway didn\'t respond. Please try again.');
        }
        else {
