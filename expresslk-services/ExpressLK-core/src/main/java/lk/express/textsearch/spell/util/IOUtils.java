...
/**
 * IO utilities to help work with Java's extremely verbose yet surprisingly
 * non-useful IO builtins. These methods are excerpted from ResearchAssistant.
 * 
 * @author dramage
 */
public class IOUtils {
	...
	public static Iterable<String> readLines(InputStream stream) throws QuietIOException {
		return new OnePassIterable<String>(new LineReaderIterator(new BufferedReader(new InputStreamReader(stream))));
	}
