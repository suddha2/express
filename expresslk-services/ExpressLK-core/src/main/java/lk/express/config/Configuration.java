 ...
 * {AbstractConfiguration} class, which is the base class of most configuration
 * implementations provided by this package, per default returns <b>null</b> if
 * a property is not found, but provides the
